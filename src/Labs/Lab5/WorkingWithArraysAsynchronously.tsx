...
export default function WorkingWithArraysAsynchronously() {
    ...
    return (
        <div id="wd-asynchronous-arrays">
            ...
            <h4>Todos <FaPlusCircle onClick={postTodo} className="text-primary float-end fs-3 me-3" id="wd-post-todo" />
            ...
            <ul className="list-group">
                {todos.map((todo) => (
                    <li key={todo.id} className="list-group-item">
                        ...
                        <input type="checkbox" defaultChecked={todo.completed} style={{ textDecoration: todo.completed ? "line-through" : "none" }} className="form-check-input me-2 float-start"
